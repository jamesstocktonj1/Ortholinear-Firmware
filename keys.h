...
uint8_t secondaryLayer[4][12] = {
  HID_KEY_TAB,          HID_KEY_GRAVE,    HID_KEY_W,        HID_KEY_E,    HID_KEY_R,    HID_KEY_T,      HID_KEY_Y,          HID_KEY_MINUS,      HID_KEY_EQUAL,    HID_KEY_BRACKET_LEFT, HID_KEY_BRACKET_RIGHT,HID_KEY_ENTER, 
