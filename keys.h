...
uint8_t primaryLayer[4][12] = {
  ...
  HID_KEY_CONTROL_LEFT, HID_KEY_GUI_LEFT, HID_KEY_ALT_LEFT, USR_KEY_0,    USR_KEY_1,    HID_KEY_SPACE,  HID_KEY_NONE,       HID_KEY_ARROW_LEFT, HID_KEY_ARROW_UP, HID_KEY_ARROW_DOWN,   HID_KEY_ARROW_RIGHT,  HID_KEY_DELETE, 
};
