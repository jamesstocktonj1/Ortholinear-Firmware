...
uint8_t secondaryLayer[4][12] = {
  ...
  HID_KEY_SHIFT_LEFT,   HID_KEY_EUROPE_1, HID_KEY_CAPS_LOCK,HID_KEY_C,    HID_KEY_V,    HID_KEY_B,      HID_KEY_N,  HID_KEY_M,            HID_KEY_COMMA,          HID_KEY_APOSTROPHE,   HID_KEY_SLASH,        HID_KEY_SHIFT_RIGHT, 
  HID_KEY_CONTROL_LEFT, HID_KEY_GUI_LEFT, HID_KEY_ALT_LEFT, USR_KEY_0,    USR_KEY_1,    HID_KEY_SPACE,  USR_KEY_2,  HID_KEY_DELETE,       HID_KEY_ARROW_LEFT,     HID_KEY_ARROW_UP,     HID_KEY_ARROW_DOWN,   HID_KEY_ARROW_RIGHT,  
};
